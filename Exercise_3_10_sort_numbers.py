# -*- coding: utf-8 -*-
"""
Created on Mon Sep 16 11:43:09 2024
...
print('Unsorted: {:5.3f},{:5.3f}, {:5.3f} ,{:5.3f}, {:5.3f}, {:5.3f}'.format(numbers[0], numbers[1], numbers[2],numbers[3], numbers[4], numbers[5]))
...
print('Sorted: {:5.3f},{:5.3f}, {:5.3f} ,{:5.3f}, {:5.3f}, {:5.3f}'.format(numbers[0], numbers[1], numbers[2],numbers[3], numbers[4], numbers[5]))
